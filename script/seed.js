...
const seed = async () => {
  try {
    ...
    // let customer11 = await User.create({
    //   email: "aashness7@pagesperso-orange.fr",
    //   password: "zkD33X4eO",
    //   firstName: "Adele",
    //   lastName: "Ashness",
    //   address: "0 Grim Crossing",
    //   isAdmin: false,
    // })
    // let customer12 = await User.create({
    //   email: "vegger8@forbes.com",
    //   password: "BrSQO7VYZZ",
    //   firstName: "Virgilio",
    //   lastName: "Egger",
    //   address: "1522 Bay Drive",
    //   isAdmin: false,
    // })
    // let customer13 = await User.create({
    //   email: "chyde9@weather.com",
    //   password: "gKlm7Fg32",
    //   firstName: "Cris",
    //   lastName: "Hyde",
    //   address: "877 Judy Pass",
    //   isAdmin: false,
    // }),
